...
class Creditario::CrowdfundingInvestorsTest < CreditarioAPITest
  def setup
    super
    @subject = Creditario::Crowdfunding::Investors
    @headers = {
  ...
  def test_it_retrieves_an_investor
    ...
    assert result.is_a? Creditario::Crowdfunding::Investor
  end
